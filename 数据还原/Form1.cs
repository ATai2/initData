...
namespace 数据还原
{
    public partial class Form1 : Form
    {
        ...
        private void btnDb_Click(object sender, EventArgs e)
        {
                ...
                for (int j = 0; j < Convert.ToInt16(textBox2.Text.Trim()); j++)
                {
                    try
                    {
                      var  sql = "insert into testTable ("
                            ...
                            + "values('sKey" + j + "','xinhua" + j + "','新华医院','111223333','国有医院','201701051123" + j + "','张三" + j + "','男','居民医保'," +
                              "'1960012077775','床位费','0.0','西药费','0.0','中药费','0.0','氧气费','0.0','护理费','0.0','检查费','0.0','材料费','0.0','0.0" + j + "','0.0" + j + "','0.0" + j + "','0.0" + j + "','0.0" +j + "','0.0" + j + "','0.0" + j + "','0.0" + j + "','0.0" + i + "','0.0" + i + "','999胃泰','瓶','3','90.00','270.00','CT','次','1','1200.00','1200.00','血常规','次','2','70.00','140.00','手术费','次','1','7000.00','7000.00','手术护理费','天','41','200.00','8000.00','床位费','天','40','120.00','4800.00','B超','次','2','600.00','1200.00','中成药','副','7','40.00','280.00','治疗费','次','8'," +
                              ...
                              "'ty_FillInfo" + i + "','0080000000','0000005132','2017-01-06 09:47:21','',''," +
                              "'2017-01-06 09:47:21','0','111','2C1BAEC344F10A51F12404E8E176E9EFED2D7090A95FEF1A396CCEA366CC3CF1','64','2','2','2','2','0'," +
                              "'D:\\天庸公司\\数字凭证(制作)\\上海市财政局_非税收入_上海交通大学医学院附属新华医院_xinhua" + i+j.ToString("000") + ".tiff','20170109103132','');";
            ...
            SqlHelper.ExecuteNonQuery(testConn,CommandType.Text,sqlsb.ToString());
